...
Failure.track = function Failure_track (fn, sff) {
  ...
  fn.__frames__ = makeFramesGetter(sff || Failure_track);
...
Failure.wrap = function Failure_wrap (fn) {
  ...
  return Failure.track(Failure.ignore(wrapper), Failure_wrap);
};
...
if (typeof Object.defineProperty === 'function') {
  Object.defineProperty(proto, 'frames', {
    get: function () {
      ...
      var frames = trimFrames(this._getFrames(), this.sff);
